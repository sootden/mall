        ...
        <div className="border-2 border-sky-200 mt-10 m-2 m-4">
            ...
            <div className="flex justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    <input className="w-4/5 p-6 rounded-r border border-solid shadow-md" name="title" type={'text'} value={todo.title} onChange={handleChangeTodo}></input>
                </div>
            </div>
            <div className="flex justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    <div className="w-1/5 p-6 text-right font-bold">DUEDATE</div>
                    <input className="w-4/5 p-6 rounded-r border border-solid shadow-md" name="dueDate" type={'date'} value={todo.dueDate} onChange={handleChangeTodo}></input>
                </div>
            </div>
            <div className="flect justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
            ...
            <div className="flex justify-end p-4">
                ...
                <button type="button" className="rounded p-4 m-2 text-xl w-32 text-white bg-red-500" onClick={handleClickModify}>Modify</button>
            </div>
        </div>
    );
};
