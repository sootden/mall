...
const AddComponent = () => {
    ...
    //결과 상태가 있는 경우에 ResultModal 을 보여준다.
        ...
        <div className="border-2 border-sky-200 mt-10 m-2 p-4">
            ...
            <div className="flex justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    <input className="w-4/5 p-6 rounded-r border border-solid border-neutral-500 shadow-md" name="writer" type={'date'} value={todo.dueDate} onChange={handleChangeTodo}></input>
                </div>
            </div>
